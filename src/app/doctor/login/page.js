    ...
    try {
      ...
      if (result?.error) {
        ...
        if (session?.user?.role === 'Doctor') {
          ...
          setError('Access denied. Doctor login only.');
          signIn('signout');
        }
      }
    } catch (err) {
      ...
      >
        <Card className="border-2 border-border shadow-xl">
          <CardHeader className="space-y-1 text-center">
            ...
            <CardDescription>Sign in to access your doctor portal</CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="text-center text-sm text-muted-foreground">
                ...
                <a href="/patient/login" className="hover:underline">Patient Login</a>
              </div>
            </form>
          </CardContent>
        </Card>
